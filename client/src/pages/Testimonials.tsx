...
export default function Testimonials() {
  return (
    <>
      <SEO
        title="Client Testimonials | Nukleo Digital"
        description="Read what our clients say about working with Nukleo. Trusted by startups, SMBs, and enterprises for AI transformation and digital innovation."
        keywords="client testimonials, reviews, case studies, client success stories, AI transformation"
      />
          ...
          <section className="container px-6 md:px-12 mb-20">
            <div className="max-w-4xl">
              <div className="inline-block px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-6">
                <span className="text-sm font-mono text-white/70">CLIENT STORIES</span>
              </div>
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
                Trusted by Organizations
                <br />
                <span className="text-white/60">Around the World</span>
              </h1>
              <p className="text-xl text-white/70 leading-relaxed">
                From startups to established enterprises, our clients trust us to deliver exceptional results. 
                Here's what they have to say about working with Nukleo.
              </p>
            </div>
          </section>
          ...
          <section className="container px-6 md:px-12 mt-32">
            ...
            ">
              ...
              <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
                Let's build something exceptional together. Start your AI transformation journey with Nukleo.
              </p>
              <a
                href="/contact"
                className="
