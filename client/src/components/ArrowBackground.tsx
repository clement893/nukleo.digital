...
export default function ArrowBackground({ variant = 'default' }: ArrowBackgroundProps) {
  ...
  const positions = variant === 'default' 
    ? [
        { top: '15%', left: '5%', size: 250, opacity: 0.01 },
        { bottom: '20%', right: '8%', size: 280, opacity: 0.012 },
        { top: '55%', left: '40%', size: 200, opacity: 0.008 },
      ]
    : [
        { top: '25%', right: '10%', size: 260, opacity: 0.011 },
        { bottom: '15%', left: '6%', size: 240, opacity: 0.009 },
        { top: '60%', right: '35%', size: 220, opacity: 0.01 },
      ];
