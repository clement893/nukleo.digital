...
export const testimonials: Testimonial[] = [
  {
    client: "Affilia",
    contact: "Bernard Colas",
    title: "Partner & Co-Founder, Affilia Légal, SENCRL",
    company: "Affilia",
    text: "From the earliest stages of ideation to the final implementation, Nukleo took the time to deeply understand our values, our culture, and the story we wanted to tell. The process never felt transactional; it was a true partnership built on creativity, collaboration, and trust."
  },
  {
    client: "CDÉNÉ",
    contact: "Amel Souid",
    ...
    company: "CDÉNÉ",
    text: "A special mention must go to Margaux, whose leadership and insight were invaluable throughout. Her ability to translate abstract ideas into a coherent, impactful visual and verbal identity was remarkable. Under her guidance, the entire team ensured that we felt supported and involved at every stage."
  },
  {
    client: "GoCoupons",
    contact: "Denise Hobbs",
    title: "CEO",
    company: "GoCoupons",
    text: "We are genuinely proud of the outcome, a refreshed brand that reflects who we are today while looking confidently toward the future. We wholeheartedly recommend Nukleo to any organization seeking a thoughtful, strategic, and human-centered rebranding experience."
  },
  {
    client: "Humankind Global Recruitment",
    contact: "Rick Purcell",
    title: "Managing Director",
    company: "Humankind Global Recruitment",
  ...
  {
    client: "Spruce Creative",
    contact: "Andrew Vincent",
    title: "Creative Director",
    company: "Spruce Creative",
  ...
  },
  {
    ...
    text: "Working with the Nucléus team on the redesign of our website, Successcolaire.ca, was an incredibly positive experience. From the very start, their team demonstrated exceptional attentiveness, taking the time to deeply understand our needs and business objectives. They have a people-first approach, select their clients based on shared values, and it's clear that they are genuinely committed to going beyond the mandate. The impact of this redesign was immediate: smoother navigation, a modern design, and greater online visibility. Our new website reinforces our company's positioning and is perfectly aligned with our mission. What sets Nucléus apart is their ability to combine technical expertise, strategic insight, and human-centered support. They don't just execute a mandate—they act as true partners, offering tailored solutions and anticipating our needs. I highly recommend Clément and his team to any company looking to modernize its image and maximize its online impact. Their professionalism, creativity, and dedication make all the difference!"
  },
  {
    client: "Summit Law",
    ...
    title: "Associate",
    company: "Summit Law",
    text: "Working with Nukleo on our firm's rebranding was an exceptional experience from start to finish. Their team demonstrated a rare ability to balance the expectations of our industry with a forward-thinking and innovative approach. They seamlessly merged elements of our legacy with modern design and strategy, resulting in a brand identity that feels both authentic and future-ready."
  },
  {
    client: "Toit à moi",
    contact: "Serge Lareault",
    title: "Executive Director",
    company: "Toit à moi",
    text: "When Toit à moi launched in 2025, we entrusted the creation of our website to Nucleus. Our charitable organization wanted a brand image that felt vibrant and positive, despite the often difficult subject of homelessness. The team rose to the challenge brilliantly, creating a website that resonates with both younger audiences and our main demographic those over 40. The site is effective and easy to navigate. Bravo!"
  },
  {
