    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      <div className="container text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-purple-900/30 backdrop-blur-sm border border-white/10">
          <span className="text-sm font-medium text-white">SMB AI Technology Radar 2024</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-8">
          Cut through the hype. Discover AI tools with proven ROI, realistic budgets, and fast implementation for SMBs and nonprofits.
        </p>
