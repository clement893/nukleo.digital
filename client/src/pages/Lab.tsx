              ...
              <div className="grid md:grid-cols-2 gap-8">
                {capabilities.map((capability, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-accent/20 to-purple-600/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
