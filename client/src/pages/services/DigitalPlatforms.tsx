  ...
  const services = [
    {
      ...
      description: "Build bespoke AI-powered applications tailored to your unique business processes and requirements."
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: "Enterprise-grade infrastructure that grows with your business while maintaining security."
    },
    {
      icon: Layers,
      title: "API Development",
      description: "Create robust APIs that enable AI functionality across your digital ecosystem."
    }
  ];
    ...
    <>
      ...
      <div className="container pt-24 pb-4">
        <Breadcrumb items={[
          ...
          { name: 'Digital Platforms', url: '/services/digital-platforms' }
        ]} />
      </div>
